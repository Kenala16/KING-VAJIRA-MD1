...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'ᴋᴇᴋᴇᴛsᴏ 𝐁𝐨𝐭' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'ᴋᴇɴᴅʀɪᴄᴋ' : process.env.OWNER_NAME,
  sessionName:  process.env.SESSION_ID === undefined ? false : process.env.SESSION_ID,
  author:  process.env.PACK_INFO.split(";")[0] === undefined ? 'ᴋᴇɴᴅʀɪᴄᴋ' : process.env.PACK_INFO.split(";")[0],
  auto_read_status :  process.env.AUTO_READ_STATUS === undefined ? false : process.env.AUTO_READ_STATUS,
  packname:  process.env.PACK_INFO.split(";")[1] === undefined ? 'ᴋᴇɴᴅʀɪᴄᴋ-Md' : process.env.PACK_INFO.split(";")[1],
  ...
  BRANCH: 'main', 
  ALIVE_MESSAGE:  process.env.ALIVE_MESSAGE === undefined ? 'Hi its ᴋᴇᴋᴇᴛsᴏ bot am here' : process.env.ALIVE_MESSAGE,
